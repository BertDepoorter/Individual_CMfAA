  ...
  subroutine rm1d_init_one_grid(ixGmin1,ixGmax1,ixmin1,ixmax1,w,x)
    ...
    if (iprob==1) then
        where (abs(x(ixmin1:ixmax1,1))<0.5d0)
           w(ixmin1:ixmax1,rho_)   = 1.5d0
           w(ixmin1:ixmax1,mom(1)) = 0.0d0
           w(ixmin1:ixmax1,e_)     = 1.5d0
        elsewhere
           w(ixmin1:ixmax1,rho_)   = 0.5d0
           w(ixmin1:ixmax1,mom(1)) = 0.0d0
           w(ixmin1:ixmax1,e_)     = 0.5d0
        end where
    ! iprob==2  shock & shock
    else if (iprob==2) then
        where (abs(x(ixmin1:ixmax1,1))<0.5d0)
           w(ixmin1:ixmax1,rho_)   = 1.0d0
           w(ixmin1:ixmax1,mom(1)) = 2.0d0
           w(ixmin1:ixmax1,e_)     = 1.5d0
        elsewhere
           w(ixmin1:ixmax1,rho_)   = 1.0d0
           w(ixmin1:ixmax1,mom(1)) = -2.0d0
    ...
    ! iprob==3  rarefaction wave
        ...
        where (abs(x(ixmin1:ixmax1,1))<0.5d0)
           w(ixmin1:ixmax1,rho_)   = 1.0d0
           w(ixmin1:ixmax1,mom(1)) = -0.5d0
           w(ixmin1:ixmax1,e_)     = 1.0d0
        elsewhere
           w(ixmin1:ixmax1,rho_)   = 1.0d0
           w(ixmin1:ixmax1,mom(1)) = 0.5d0
           w(ixmin1:ixmax1,e_)     = 1.0d0
